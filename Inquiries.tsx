        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Track and manage customer inquiries ({inquiries.length} total)
            </p>
          </div>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-sm text-muted-foreground">
                  {searchQuery || statusFilter !== "all"
                    ...
                    : "Inquiries will appear here when customers submit the form"}
                </p>
              </div>
            ) : (
                      ...
                      <tr key={inquiry.id} className="border-b last:border-0 hover:bg-muted/30">
                        ...
                        <td className="p-4">
                          <Select
                            ...
                            onValueChange={(v) => handlePriorityChange(inquiry.id, v)}
                          >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {selectedInquiry.quantity?.toLocaleString() || "-"}
                      </p>
                    </div>
                    <div>
                      ...
                      <div className="mt-1">
                        <Select
                          ...
                          onValueChange={(v) =>
                            handleStatusChange(selectedInquiry.id, v as InquiryStatus)
                          }
                        >
